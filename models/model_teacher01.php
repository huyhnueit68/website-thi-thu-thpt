...
class Model_Teacher01 extends Database
{
    ...
    {
        $sql = "INSERT INTO tests (test_code,test_name,grade_id,subject_id,total_questions,time_to_do,note,status_id) VALUES ($test_code,'$test_name', $grade_id, $subject_id, $total_questions, $time_to_do, '$note', 2)";
        $this->set_query($sql);
        return $this->execute_return_status();
    }
