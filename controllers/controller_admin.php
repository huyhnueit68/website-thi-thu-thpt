...
class Controller_Admin
{
    ...
    {
        $model = new Model_Admin();
        return $model->add_question($subject_id, $question_content, 12, 12, $answer_a, $answer_b, $answer_c, $answer_d, $correct_answer, $level_id, $this->info["username"]);
    }
    ...
    public function get_dashboard_info()
    {
        ...
        $total = array($admin, $teacher, $student);
        return $total;
    }
